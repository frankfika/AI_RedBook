...
Manus 的系统提示词，早就有了，现在 Manus 类产品越来越多，在这里备份一下，方便以后参考。

![Image](./Manus.assets/640-20250507231502920.png)

做通用智能体产品的朋友可以参考一下，从这些信息中能看到比较多产品细节，能帮助你在AI应用上更进一步！

说一下这类产品系统提示词的作用，不是直接复制粘贴用的，更多是作为功能、产品细节、架构的参考。掌握了这些"幕后机制"，这种独特视角会让你脱颖而出。

## **01 目录**

Manus 系统的架构比较复杂，提示词分散在四个文件中。

这种复杂性正是它强大功能的基础，这些透露出来的内容也是我们能学习的宝库：![Image](./Manus.assets/640.png)
